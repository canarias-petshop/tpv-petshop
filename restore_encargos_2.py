...
# 2. Read Excel
df = pd.read_excel('Backups_Datos_Nube/Backup_2026_07_08_21_50/6_Encargos_y_Pedidos.xlsx')
...
print("Restore complete! Encargos table is now identical to the July 8th 21:50 backup.")
