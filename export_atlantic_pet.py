...
# Some products might be "Atlantic Pet", "ATLANTIC PET" or just "Atlantic"
res = supabase.table("productos").select("*").ilike("marca", "%Atlantic%").execute()
...
print(f"Exportados {len(products)} productos de Atlantic Pet a {csv_file}")
