            ...
            if res_citas.data:
                ...
                for c in res_citas.data:
                    ...
                    citas_formateadas.append({
                        "Ver Ficha": False,
                        "mascotas_id": mascota_info.get('id'),
                        "Borrar": False,
                        "id": c['id'],
                        "Día": dt_obj.date(),
                        "Hora": dt_obj.time(),
                ...
                if df_citas.empty:
                    ...
                    ed_citas = st.data_editor(
                        df_citas[['Ver Ficha', 'Borrar', 'id', 'mascotas_id', 'Día', 'Hora', 'Estado', 'Duración (min)', 'Peluquero/a', 'Servicio', 'Observaciones', 'Mascota', 'Dueño', 'Teléfono', 'WhatsApp']],
            ...
            for d_idx in range(7):
                ...
                if citas_hoy:
                    for dt_start, cita in citas_hoy:
                        ...
                        elif estado_c == "Ofrecida": border_color = "#00acc1"
